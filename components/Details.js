  ...
  async render() {
    if (this.dataset.catId) {
      ...
      this.root.querySelector(
        ".temperament"
      ).innerHTML = `<strong>temperament:</strong><br> ${this.c.temperament}`;
      this.root.querySelector(
        ".breed"
      ).innerHTML = `<strong>breed:</strong><br> ${this.c.name}`;
      this.root.querySelector(
        ".description"
      ).innerHTML = `<strong>description:</strong><br> ${this.c.description}`;
      this.root.querySelector(
        ".lifespan"
      ).innerHTML = `<strong>lifespan:</strong><br> ${this.c.life_span} years`;
